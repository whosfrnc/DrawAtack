...
class Tutorial(models.Model):
    ...
    categoria = models.CharField(max_length=30, choices=CATEGORIAS, null=True)
    imagem = models.ImageField(upload_to='tutoriais/', null=True)
...
class Suporte(models.Model):
    usuario = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)  # Usa o modelo de usuário personalizado
