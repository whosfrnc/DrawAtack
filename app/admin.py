...
class TutorialAdmin(admin.ModelAdmin):
    list_display = ('titulo', 'autor', 'categoria', 'data_criacao')  # Verifique esta linha
# Admin para Desenho
...
class SuporteAdmin(admin.ModelAdmin):
    list_display = ['usuario', 'mensagem']  # Certifique-se de que 'data_criacao' existe no modelo Suporte
